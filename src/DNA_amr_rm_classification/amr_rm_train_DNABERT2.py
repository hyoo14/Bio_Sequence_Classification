...
train_dir = "/content/drive/MyDrive/playground_test_anything/bio_AMR_ARG/_NT_test/rm_df9class_CARD_MEGARes_train_dc.csv"
test_dir = "/content/drive/MyDrive/playground_test_anything/bio_AMR_ARG/_NT_test/rm_df9class_CARD_MEGARes_test_dc.csv"
valid_dir = "/content/drive/MyDrive/playground_test_anything/bio_AMR_ARG/_NT_test/rm_df9class_CARD_MEGARes_val_dc.csv"
aug_dir = "none"
...
train_df['DNA Sequence'] = train_df['DNA Sequence'].apply(lambda x: x[:510])
test_df['DNA Sequence'] = test_df['DNA Sequence'].apply(lambda x: x[:510])
valid_df['DNA Sequence'] = valid_df['DNA Sequence'].apply(lambda x: x[:510])
...
# Hugging Face repo 
repo_id = "hyoo14/DNABERT2_AMR_RM"

# upload file path
local_file_path = "/content/lora_state_dict.safetensors"
...
tokenizer.push_to_hub("hyoo14/DNABERT2_AMR_RM")
...
downloaded_file = hf_hub_download(repo_id="hyoo14/DNABERT2_AMR_RM",
